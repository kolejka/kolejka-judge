...
def config_parser_task(parser, judge_path=None):
    ...
    parser.add_argument('--library-path', type=pathlib.Path, help='kolejka-judge library file')
    ...
    def execute(args):
        ...
        kolejka_task(args.task, args.tests, args.solution, args.judge, library_path=args.library_path, debug=args.debug, callback_url=args.callback)
    parser.set_defaults(execute=execute)
...
def config_parser_client(parser, judge_path=None):
    ...
    def execute(args):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            kolejka_task(temp_dir, args.tests, args.solution, args.judge, exist_ok=True, library_path=args.library_path, debug=args.debug, callback_url=args.callback)
