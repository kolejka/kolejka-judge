...
\begin{itemize}
    ...
    The usage of keyword over regular arguments in \python{add_steps()} is purely optional, designed to provide an
    option to specify custom step identifiers.
    \item Launching the checker (line 7)

    The \python{run()} method runs the configured pipeline, and returns a 2-tuple, consisting of the final
