\section{Checking}\label{sec:checkingss}
    \python{Checking} class's responsibility is to provide a readable and clean interface for binding the two
    abstractions, \hyperref[sec:steps]{Steps} and \hyperref[sec:environments]{Environments}, together.
