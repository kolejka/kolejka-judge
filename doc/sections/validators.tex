\section{Validators}\label{sec:validators}
    ...
    \hyperref[sec:verify_prerequisites]{\python{verify_prerequisites()}} method, and the checking terminates.
    ...
    \hyperref[sec:verify_postconditions]{\python{verify_postconditions()}} method, and consequently as the final step's
    exit status.
