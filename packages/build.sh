...
kolejka_judge_wheel="$(find dist -name "KolejkaJudge-*.whl" |sort |tail -n 1)"

./wheel_executable.py --wheel "${kolejka_judge_wheel}" --main kolejka.judge.main  dist/kolejka-judge
